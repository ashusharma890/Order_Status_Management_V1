...
const executeOrder = () => {
	...
	orderStatuses[0].classList.add('btn-dark');
	...
	chefReceived()
		...
		.then(() => {
			...
			orderStatuses[9].classList.add('btn-dark')
		})
...
const chefReceived = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[1].classList.add('btn-dark')
			resolve()
		}, 2000)
	})
}
...
const pizzaSauceAdded = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[2].classList.add('btn-dark')
			resolve()
		}, 10000)
	})
}
...
const firstLayerOfCheezeAdded = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[3].classList.add('btn-dark')
			resolve()
		}, 5000)
	})
}
...
const toppingsAdded = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[4].classList.add('btn-dark')  
			resolve()
		}, 12000)
	})
}
...
const secondLayerOfCheezeAdded = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[5].classList.add('btn-dark')
			resolve()
		}, 5000)
	})
}
...
const pizzaBaked = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[6].classList.add('btn-dark')
			resolve()
		}, 15000)
	})
}
...
const oreganoAddedAndPacked = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[7].classList.add('btn-dark')
			resolve()
		}, 8000)
	})
}
...
const packageReceivedAtCounter = () => {
	return new Promise((resolve, reject) => {
		setTimeout(() => {
			...
			orderStatuses[8].classList.add('btn-dark')
			resolve()
		}, 2000)
